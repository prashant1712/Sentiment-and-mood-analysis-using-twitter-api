...
<head>
    ...
    <body>
        ...
        font-size: 23px;">
            ...
            <div style="font-family: arial;
                 ...
                 font-size: 23px;">
      <% double po=(Double)request.getAttribute("Positive Percentage");
        double no=(Double)request.getAttribute("Negative Percentage");
  ...
  final CategoryAxis categoryAxis = new CategoryAxis("Sentiment1: Positive     Sentiment2: Negative");
  ...
  chart = new JFreeChart("Sentiment Analysis", JFreeChart.DEFAULT_TITLE_FONT, 
  plot, true);

  chart.setBackgroundPaint(new Color(249, 231, 236));

  Paint p9 = new GradientPaint(
 0.0f, 0.0f, new Color(16, 89, 172), 0.0f, 0.0f, new Color
   (201, 201, 244));

  renderer.setSeriesPaint(1, p9);

  Paint p10 = new GradientPaint(
  0.0f, 0.0f, new Color(255, 35, 35), 0.0f, 0.0f, new Color
   (255, 180, 180));

  renderer.setSeriesPaint(2, p10);
 ...
 final File file1 = new File("F://netbeans//minor2//web/sentiment.png");
...
%>                                          
<body>
    <img alt="logo" src="sentiment.png" width="50%" height="50%"/>
</body>
